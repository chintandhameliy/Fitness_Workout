...
public class Femaleshowdata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_femaleshowdata);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back  = new Intent(Femaleshowdata.this,Femaleworkout.class);
                startActivity(back);
                finish();
            }
        });
